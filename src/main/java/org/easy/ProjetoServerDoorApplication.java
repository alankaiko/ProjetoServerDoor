...
public class ProjetoServerDoorApplication {
	...
	private static final Logger LOG = LoggerFactory.getLogger(ProjetoServerDoorApplication.class);
	
    public static void main(String[] args) {
              
        SpringApplication app = new SpringApplication(ProjetoServerDoorApplication.class);
